...
void Data::c_relative_evolution()
{
    ...
    if (this->_data[this->_data.size() - this->_period - 1] * 100 != 0) {
        if (this->_data[this->_data.size() - 1] > this->_data[this->_data.size() - this->_period - 1]) {
            result = abs((this->_data[this->_data.size() - 1] - this->_data[this->_data.size() - this->_period - 1]) / this->_data[this->_data.size() - this->_period - 1] * 100);
        } else {
...
void Data::loop()
{
    ...
    if (this->_period > this->_data.size()) {
        exit(84);
    }
