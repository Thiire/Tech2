...
C_4011::C_4011(const std::string &value)
{
    this->size = 14;
...
{
    this->value[2].setState(NAND(this->value[0].getState(), this->value[1].getState()));
    this->value[3].setState(NAND(this->value[4].getState(), this->value[5].getState()));
    this->value[9].setState(NAND(this->value[7].getState(), this->value[8].getState()));
    this->value[10].setState(NAND(this->value[11].getState(), this->value[12].getState()));
    if (pin < this->size) {
...
std::string C_4011::getType() const
{
    return "4011";
}
